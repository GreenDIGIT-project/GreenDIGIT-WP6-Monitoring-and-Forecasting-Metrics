...
class Settings:
    # --- Base & Auth ---
    base_url: str = os.getenv("BASE_URL", "https://greendigit-cim.sztaki.hu").rstrip("/")
    # Note: default path uses the hyphenated endpoint confirmed by your probe
    auth_path: str = os.getenv("AUTH_PATH", "gd-cim-api/v1/token")
    ...
    submit_path: str = os.getenv("SUBMIT_PATH", "/gd-cim-api/v1/submit")
    metrics_me_path: str = os.getenv("METRICS_ME_PATH", "/gd-cim-api/v1/metrics/me")
